...
REFERENCE_TEXTS = [
    ...
    ("Gettysburg Address", "Abraham Lincoln", 1_938),
    ...
    ("A Study in Scarlet", "Arthur Conan Doyle", 61_757),
    ("Peter Pan", "J.M. Barrie", 67_181),
    ("The Prince", "Machiavelli", 70_730),
    ("Treasure Island", "R.L. Stevenson", 97_642),
    ("Frankenstein", "Mary Shelley", 101_770),
    ("Tom Sawyer", "Mark Twain", 102_285),
    ("Dorian Gray", "Oscar Wilde", 109_503),
    ("Sherlock Holmes", "Arthur Conan Doyle", 141_038),
    ("Wuthering Heights", "Emily Brontë", 166_761),
    ("Pride and Prejudice", "Jane Austen", 174_412),
    ("A Tale of Two Cities", "Charles Dickens", 189_576),
    ("Dracula", "Bram Stoker", 216_384),
    ("Great Expectations", "Charles Dickens", 254_088),
    ("Jane Eyre", "Charlotte Brontë", 257_652),
    ("Crime and Punishment", "Fyodor Dostoevsky", 287_138),
